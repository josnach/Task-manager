...
export const TaskAssigneesSelector = ({
    ...
    const handleSave = () => {
       mutate({
       ...
       },
        {
            ...
            onError: (error: any) => {
                const errorMessage = error.response?.data?.message || "Failed to updated assignees";
    ...
    return (
        <div className="mb-6 mt-4">
            <h3 className="text-bold font-medium text-muted-foreground mb-2">
            Assignees:
            </h3>

            <div className="flex flex-wrap gap-4 mb-2">
            {selectedIds.length === 0 ? ( <span>Unassigned</span> 
            ) : (
            ...
            <div className="relative">
                <button className="text-sm text-muted-foreground border rounded px-3 py-2 text-left bg-white"
                ...
                {dropDownOpen && (
                    <div className="absolute z-10 mt-1 w-full bg-white rounded shadow-lg max-h-60 overflow-y-auto">
                        ...
                        {projectMembers.map((m) => (
                            <label className="flex items-center px-2 py-1 cursor-pointer hover:bg-gray-50" key={m.user._id}>
                        ...
                        <div className="flex justify-between px-2 py-1">
                            <Button
                             ...
                             onClickCapture={() => setDropDownOpen(false)} disabled={isPending}>
                                 Cancel
                                </Button>
